             ...
             <div class="card-body">
                <?php $form = ActiveForm::begin(['id' => 'confrimation-form']); ?>
                    ...
                    <p>
                        ...
                        <li> <b> EDUCATION INFORMATION: </b> you give your full consent and authorize Mhasibu Hospital to contact each of your education 
                            ...
                            requested information directly to Mhasibu Hospital. Any information received will be treated with due regard to confidentiality
                        </li>

                        <li> <b> WORK EXPERIENCE: </b> You are aware Mhasibu Hospital will contact former and current employers,
